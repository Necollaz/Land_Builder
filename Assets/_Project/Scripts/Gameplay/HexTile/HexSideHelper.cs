...
public static class HexSideHelper
{
    public static int GetSideIndex(Vector2Int thisCoords, Vector2Int toCoords)
    {
        ...
        Vector2Int[] offsets = evenRow ? new[] { new Vector2Int(1,0), new Vector2Int(0,-1), new Vector2Int(-1,-1), new Vector2Int(-1,0), new Vector2Int(-1,1), new Vector2Int(0,1) } 
            : new[] { new Vector2Int(1,0), new Vector2Int(1,-1), new Vector2Int(0,-1), new Vector2Int(-1,0), new Vector2Int(0,1), new Vector2Int(1,1) };

        int worldIndex = -1;
        
        for (int i = 0; i < 6; i++)
            if (offsets[i] == direction) { worldIndex = i; break; }
